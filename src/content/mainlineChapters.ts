...
const specs: readonly MainlineChapterSpec[] = [
  {
    ...
    introLines: [
      ...
      { speakerId: "arthur", emotion: "anger", text: "我不知道这里的神会不会听见。但我知道，想杀我的人正借她的名字说话。" },
      { speakerId: "arthur", emotion: "doubt", text: "铁环落地的声音先于疼痛抵达。系统在我眼前展开：力量、敏捷、体质、意志，以及一条没有解释的危险预警。" },
      { stageDirection: "一道白光割开烟尘。女神的赐福没有替亚瑟挥剑，只把他看见的每一条逃生路径照得更清楚。" },
      { speakerId: "hans", emotion: "resolve", text: "巡逻队不会问你是不是圣人。你敢从边境村里把人带出来，就先学会用盾牌把他们送回去。" },
      { speakerId: "asnoka", text: "东边是哨线，西边是火。你若要报仇，先得活到能自己挑选战场的时候。" },
    ],
    secondLines: [
      { stageDirection: "临时军牌沾着刑场的灰。边境闸门正在下降，身后跟着被巡逻队带出的农户与伤员。" },
      { speakerId: "arthur", text: "他们想用一块牌子决定谁算自己人。那我就用这块牌子，把还没被写进名单的人送过去。" },
      { speakerId: "hans", emotion: "resolve", text: "哨兵不是敌人，只是被命令守住一条线。别让恐惧替他们把闸门彻底关上。" },
      { speakerId: "asnoka", emotion: "doubt", text: "军牌能开门，也会留下名字。今天过去的人，明天都可能被两边拿来问罪。" },
    ],
    aftermathLines: [
      { speakerId: "arthur", emotion: "resolve", text: "我没有赢下一场战争，只让几个名字没有停在刑场。卫道士军国给了我临时军牌，也给了我第一份必须兑现的军令。" },
      { speakerId: "hans", text: "从今天起，别把活下来当成侥幸。有人会看见你的剑，也会看见你带走了谁。" },
    ],
    failureLines: [
      { speakerId: "arthur", emotion: "doubt", text: "刑场的门还是打开了。系统把伤势、损失和未能救下的名字一项项记下，却没有弹出重新来过的按钮。" },
      { speakerId: "asnoka", text: "先离开。欠下的解释不会消失，但活着的人还能把它补回去。" },
    ],
  },
  {
